                                ...
                                <form action="#" method="post">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <div class="icon-input">
                                                    ...
                                                    <input type="text" class="form-control custom-input" name="text"
                                                        id="text" placeholder="أدخل الاسم كاملا">
                                        ...
                                        <div class="col-lg-12 text-center mt-4">
                                            ...
                                            <a href="login.html" class="forget_password">تسجيل الدخول</a>
                                        </div>
                                    </div>
                        ...
                        <div class="content content-left d-lg-block d-none">
                            <div class="owl-carousel login-slider owl-slider">
                                <div class="login-card-slider">
                                    <figure>
                                        <img src="assets/images/login-img-slider.svg" alt="" srcset="">
                                    </figure>
                                ...
                                <div class="login-card-slider">
                                    <figure>
                                        <img src="assets/images/login-slider-img-1.png" alt="" srcset="">
                                    </figure>
                                    <h2>أفضل المستشفيات</h2>
                                    <p> نحرص على اختيار أفضل المستشفيات في تركيا، الحاصلة على شهادات
                                        .الجودة بالمعايير العالية للخدمات الطبية</p>
