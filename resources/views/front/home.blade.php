   ...
   <!-- banner-section -->
                ...
                <div class="content">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 offset-lg-1  order-0">
                            <figure >
                                <img src="{{ asset('front/assets/images/h-banner-img.png') }}" class="img-fluid" alt="" srcset="">
                            </figure>
                        </div>
                    </div>
                </div>
        ...
        <section class="majors-section">
            <div class="container">
                <div class="main-title d-flex flex-wrap justify-content-between align-items-center wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s">
                    ...
                    <a href="{{ route('front.hospitals') }}" class="btn cs-btn">عرض كل التخصصات</a>
                </div>
                <div class="content">
                    <div class="row">
                        <div class="col-lg-auto col-md-4 col-6">
                            <div class="major-card">
                                <figure>
                                    <img src="{{ asset('front/assets/images/major-1.svg') }}" class="wow zoomIn" data-wow-duration="1s" data-wow-delay="0.1s" alt="" srcset="">
                                </figure>
                        ...
                        <div class="col-lg-auto col-md-4 col-6">
                            <div class="major-card">
                                <figure>
                                    <img src="{{ asset('front/assets/images/major-2.svg') }}" class="wow zoomIn" data-wow-duration="1s" data-wow-delay="0.2s" alt="" srcset="">
                                </figure>
                                <h4 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">طب العيون</h4>
                            </div>
                        </div>
                        <div class="col-lg-auto col-md-4 col-6">
                            <div class="major-card">
                                <figure>
                                    <img src="{{ asset('front/assets/images/major-3.svg') }}" class="wow zoomIn" data-wow-duration="1s" data-wow-delay="0.3s" alt="" srcset="">
                                </figure>
                                <h4 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">طب الأسنان</h4>
                            </div>
                        </div>
                        <div class="col-lg-auto col-md-4 col-6">
                            <div class="major-card">
                                <figure>
                                    <img src="{{ asset('front/assets/images/major-4.svg') }}" class="wow zoomIn" data-wow-duration="1s" data-wow-delay="0.4s" alt="" srcset="">
                                </figure>
                                <h4 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.4s">الجهاز التنفسي</h4>
                            </div>
                        </div>
                        <div class="col-lg-auto col-md-4 col-6">
                            <div class="major-card">
                                <figure>
                                    <img src="{{ asset('front/assets/images/major-5.svg') }}" class="wow zoomIn" data-wow-duration="1s" data-wow-delay="0.1s" alt="" srcset="">
                                </figure>
                                <h4 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s">طب العظام</h4>
                            </div>
                        </div>
                        <div class="col-lg-auto col-md-4 col-6">
                            <div class="major-card">
                                <figure>
                                    <img src="{{ asset('front/assets/images/major-6.svg') }}" class="wow zoomIn" data-wow-duration="1s" data-wow-delay="0.2s" alt="" srcset="">
                                </figure>
                                <h4 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">أمراض القلب</h4>
                            </div>
                        </div>
                        <div class="col-lg-auto col-md-4 col-6">
                            <div class="major-card">
                                <figure>
                                    <img src="{{ asset('front/assets/images/major-7.svg') }}" class="wow zoomIn" data-wow-duration="1s" data-wow-delay="0.3s" alt="" srcset="">
                                </figure>
                                <h4 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">أمراض الكلى</h4>
                            </div>
                        </div>
                        <div class="col-lg-auto col-md-4 col-6">
                            <div class="major-card">
                                <figure>
                                    <img src="{{ asset('front/assets/images/major-8.svg') }}" class="wow zoomIn" data-wow-duration="1s" data-wow-delay="0.4s" alt="" srcset="">
                                </figure>
                                <h4 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.4s">طب النساء</h4>
                            </div>
                        </div>
                        <div class="col-lg-auto col-md-4 col-6">
                            <div class="major-card">
                                <figure>
                                    <img src="{{ asset('front/assets/images/major-9.svg') }}" class="wow zoomIn" data-wow-duration="1s" data-wow-delay="0.1s" alt="" srcset="">
                                </figure>
                                <h4 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s">الجهاز الهضمي</h4>
                            </div>
                        </div>
                        <div class="col-lg-auto col-md-4 col-6">
                            <div class="major-card">
                                <figure>
                                    <img src="{{ asset('front/assets/images/major-10.svg') }}" class="wow zoomIn" data-wow-duration="1s" data-wow-delay="0.1s" alt="" srcset="">
                                </figure>
                                <h4 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">أنف وأذن وحنجرة</h4>
                            </div>
                        </div>
                        <!-- <div class="col-lg-auto col-md-4 col-6">
                            <div class="major-card">
                                <figure>
                                    <img src="{{ asset('front/assets/images/major-11.svg') }}" class="wow zoomIn" data-wow-duration="1s" data-wow-delay="0.1s" alt="" srcset="">
                                </figure>
                                <h4 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">أمراض السكري</h4>
                            </div>
                        </div>
                        <div class="col-lg-auto col-md-4 col-6">
                            <div class="major-card">
                                <figure>
                                    <img src="{{ asset('front/assets/images/major-12.svg') }}" class="wow zoomIn" data-wow-duration="1s" data-wow-delay="0.1s" alt="" srcset="">
                                </figure>
                                <h4 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.4s">تخصصات أخرى</h4>
                            </div>
                        </div> -->
                    </div>
                </div>
        ...
        <section class="hospital-section">
            <div class="container">
                <div class="main-title d-flex flex-wrap justify-content-between align-items-center wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s">
                    ...
                    <a href="{{ route('front.hospitals') }}" class="btn cs-btn">عرض كل المستشفيات</a>
                </div>
                <div class="content">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="hospital-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
                                <figure>
                                    <img src="{{ asset('front/assets/images/hospital-2.png') }}" alt="" srcset="">
                                </figure>
                                <div class="hospital-rate">
                                    <div class="d-flex align-items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20.08" height="18.567"
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="hospital-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
                                <figure>
                                    <img src="{{ asset('front/assets/images/hospital-3.png') }}" alt="" srcset="">
                                </figure>
                                <div class="hospital-rate">
                                    <div class="d-flex align-items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20.08" height="18.567"
        ...
        <section class="specialists-section">
            <div class="container">
                <div class="main-title d-flex flex-wrap justify-content-between align-items-center wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s">
                    ...
                    <a href="{{ route('front.hospitals') }}" class="btn cs-btn">عرض كل الأخصائيين</a>
                </div>
                <div class="content">
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="general-card specialist-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s">
                                <figure>
                                    <img src="{{ asset('front/assets/images/specialist.png') }}" alt="" srcset="">
                                </figure>
                                <div class="general-card-body">
                                    ...
                                    <p>
                                        طبيب مناعة تركي - ألماني وأستاذ في
                                        علم الأورام بجامعة ماينز والرئيس
                                       .التنفيذي والمؤسس مع زوجته 
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="general-card specialist-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
                                <figure>
                                    <img src="{{ asset('front/assets/images/specialist-2.png') }}" alt="" srcset="">
                                </figure>
                                <div class="general-card-body">
                                    <h4>د. أنطوني روسي</h4>
                                    <h6>طب وجراحة الأعصاب</h6>
                                    <div class="d-flex align-items-center justify-content-center rate">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20.08" height="18.567"
                                            viewBox="0 0 20.08 18.567">
                                            <g id="Star" transform="translate(-3.355 -2.05)">
                                    ...
                                    <p>
                                        طبيب أعصاب مشهور عالميا وأفضل
                                        طبيب صرع في تركيا. يتخصص في 
                                       .العلاج غير الجراحي لمراحل الصرع
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="general-card specialist-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
                                <figure>
                                    <img src="{{ asset('front/assets/images/specialist-3.png') }}" alt="" srcset="">
                                </figure>
                                <div class="general-card-body">
                                    <h4>د. فوليا جولنر</h4>
                                    <h6>طب وجراحة الأسنان</h6>
                                    <div class="d-flex align-items-center justify-content-center rate">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20.08" height="18.567"
                                            viewBox="0 0 20.08 18.567">
                                            <g id="Star" transform="translate(-3.355 -2.05)">
                                    ...
                                    <p>
                                        شاركت في العديد من الندوات و
                                        المؤتمرات حول موضوع غرسات
                                       .أسنان المتخصصة والأطراف
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="general-card specialist-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.4s">
                                <figure>
                                    <img src="{{ asset('front/assets/images/specialist-4.png') }}" alt="" srcset="">
                                </figure>
                                <div class="general-card-body">
                                    <h4>د. ظافر جولباس</h4>
                                    <h6>طب وجراحة العظام</h6>
                                    <div class="d-flex align-items-center justify-content-center rate">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20.08" height="18.567"
                                            viewBox="0 0 20.08 18.567">
                                            <g id="Star" transform="translate(-3.355 -2.05)">
                                    ...
                                    <p>
                                        مؤسس مركز زراعة نخاع العظام في
                                        الأناضول، كان يعمل كأخصائي طب 
                                       .الأورام وأمراض الدم ومدير الأورام
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="general-card why-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s">
                                <figure>
                                    <img src="{{ asset('front/assets/images/why-1.svg') }}" alt="" srcset="">
                                </figure>
                                <div class="general-card-body">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="general-card why-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
                                <figure>
                                    <img src="{{ asset('front/assets/images/why-2.svg') }}" alt="" srcset="">
                                </figure>
                                <div class="general-card-body">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="general-card why-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
                                <figure>
                                    <img src="{{ asset('front/assets/images/why-3.svg') }}" alt="" srcset="">
                                </figure>
                                <div class="general-card-body">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="general-card why-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.4s">
                                <figure>
                                    <img src="{{ asset('front/assets/images/why-4.svg') }}" alt="" srcset="">
                                </figure>
                                <div class="general-card-body">
                    ...
                    <div class="owl-carousel rates-slider owl-slider">
                        <div class="rates-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s">
                            ...
                            <div class="rates-card-info">
                                <figure>
                                    <img src="{{ asset('front/assets/images/avatar.png') }}" alt="" srcset="">
                                </figure>
                                <div>
                        ...
                        <div class="rates-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
                            ...
                            <div class="rates-card-info">
                                <figure>
                                    <img src="{{ asset('front/assets/images/avatar-2.png') }}" alt="" srcset="">
                                </figure>
                                <div>
                                    <h4>رقية الشافعي</h4>
                                    <h6>‏14 يوليو، 2022</h6>
                        ...
                        <div class="rates-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
                            ...
                            <div class="rates-card-info">
                                <figure>
                                    <img src="{{ asset('front/assets/images/avatar-3.png') }}" alt="" srcset="">
                                </figure>
                                <div>
                                    <h4>عبير العمري</h4>
                                    <h6>‏21 يونيو، 2022</h6>
    ...
    <section class="offers-section">
            <div class="container">
                <div class="main-title d-flex flex-wrap justify-content-between align-items-center wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s">
                    <h2>أفضل العروض</h2>
                    <a href="{{ route('front.hospitals') }}" class="btn cs-btn">عرض كل العروض</a>
                </div>
                <div class="content">
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <a href="#">
                                <div class="offer-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s">
                                    <figure>
                                        <img src="{{ asset('front/assets/images/offer-1.png') }}" alt="" srcset="">
                                        <div class="discount">
                                            ‏20% خصم
                                        </div>
                                    </figure>
                        ...
                        <div class="col-lg-3 col-md-6">
                           <a href="#">
                            <div class="offer-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
                                <figure>
                                    <img src="{{ asset('front/assets/images/offer2.png') }}" alt="" srcset="">
                                    <div class="discount">
                                        ‏25% خصم
                                    </div>
                                </figure>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <a href="#">
                                <div class="offer-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
                                    <figure>
                                        <img src="{{ asset('front/assets/images/offer3.png') }}" alt="" srcset="">
                                        <div class="discount">
                                            ‏15% خصم
                                        </div>
                                    </figure>
                         ...
                         <div class="col-lg-3 col-md-6">
                            <a href="#">
                                <div class="offer-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.4s">
                                    <figure>
                                        <img src="{{ asset('front/assets/images/offer4.png') }}" alt="" srcset="">
                                        <div class="discount">
                                            ‏30% خصم
                                        </div>
                                    </figure>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="standers-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s">
                                <figure>
                                    <img src="{{ asset('front/assets/images/standers-1.png') }}" alt="" srcset="">
                                </figure>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="standers-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
                                <figure>
                                    <img src="{{ asset('front/assets/images/standers-2.png') }}" alt="" srcset="">
                                </figure>
                         ...
                         <div class="col-lg-4 col-md-6">
                            <div class="standers-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
                                <figure>
                                    <img src="{{ asset('front/assets/images/standers-3.png') }}" alt="" srcset="">
                                </figure>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="standers-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.4s">
                                <figure>
                                    <img src="{{ asset('front/assets/images/standers-4.png') }}" alt="" srcset="">
                                </figure>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="standers-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.5s">
                                <figure>
                                    <img src="{{ asset('front/assets/images/standers-5.png') }}" alt="" srcset="">
                                </figure>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="standers-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.6s">
                                <figure>
                                    <img src="{{ asset('front/assets/images/standers-6.png') }}" alt="" srcset="">
                                </figure>
            ...
            <div class="container">
                <div class="content">
                    <div class="row align-items-center">
                        <div class="col-lg-2">
                            <figure>
                                <img src="{{ asset('front/assets/images/contact-us.png') }}" class="wow zoomIn" data-wow-duration="1s" data-wow-delay="0.1s" alt="" srcset="">
                            </figure>
                        </div>
                        <div class="col-lg-7">
                ...
                <div class="content">
                    <div class="d-flex align-items-center flex-wrap gap-3">
                        <div class="partner-card">
                            <figure class="scale">
                                <img src="{{ asset('front/assets/images/partner-1.png') }}" class="wow zoomIn" data-wow-duration="1s" data-wow-delay="0.1s" alt="" srcset="">
                            </figure>
                        </div>
                        <div class="partner-card">
                            <figure class="scale">
                                <img src="{{ asset('front/assets/images/partner-2.png') }}" class="wow zoomIn" data-wow-duration="1s" data-wow-delay="0.2s" alt="" srcset="">
                            </figure>
                        </div>
                        <div class="partner-card">
                            <figure class="scale">
                                <img src="{{ asset('front/assets/images/partner-3.png') }}" class="wow zoomIn" data-wow-duration="1s" data-wow-delay="0.3s" alt="" srcset="">
                            </figure>
                        </div>
                        <div class="partner-card">
                            <figure class="scale">
                                <img src="{{ asset('front/assets/images/partner-4.png') }}" class="wow zoomIn" data-wow-duration="1s" data-wow-delay="0.4s" alt="" srcset="">
                            </figure>
                        </div>
                        <div class="partner-card">
                            <figure class="scale">
                                <img src="{{ asset('front/assets/images/partner-5.png') }}" class="wow zoomIn" data-wow-duration="1s" data-wow-delay="0.5s" alt="" srcset="">
                            </figure>
                        </div>
                    </div>
                </div>
