      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview" id="ul-sidebar" >
              <li class="nav-item">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Hospitals Managment System</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
<script>
// تحقق أن Toastr محمل
console.log(typeof toastr); // يجب يظهر 'function'
console.log(typeof toastr.success); // يجب يظهر 'function'
</script>

<script>
// تهيئة Toastr (هام جداً!)
if (typeof toastr !== 'undefined') {
    toastr.options = {
        ...
        "showMethod": "fadeIn",
        "hideMethod": "fadeOut",
        "rtl": false  // غيرها لـ true إذا تريد العربية من اليمين
    }
