 ...
 @section('title',' الصفحة الرئيسه للمستخدمين')
 @push('css')
      ...
      <div class="card">
            ...
            <div class="row">
                <div class="col-sm-12">
                  ...
                  <thead>
                  <tr role="row">
                    <th class="sorting sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">User Name</th>
                  ...
                  @foreach ($users as $user)
                      ...
                      <td>
                        <a class="btn btn-primary" href="{{ route('admin.users.show',$user->id) }}"><i class="fa-solid fa-eye"></i></a>
                        <a class="btn btn-warning" href="{{ route('admin.users.edit',$user->id) }}"><i class="fa-solid fa-pen-to-square"></i></a>
