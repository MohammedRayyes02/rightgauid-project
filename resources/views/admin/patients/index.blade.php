 ...
 @section('title',' الصفحة الرئيسه للمرضى')
 @push('css')
      ...
      <div class="card">
            ...
            <div class="row">
                <div class="col-sm-12">
                  ...
                  <thead>
                  <tr role="row">
                    <th class="sorting sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">Patient Name</th>
                    ...
                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">Hospital Name</th>
                  ...
                  @foreach ($patients as $patient)
                      ...
                      <td>{{ $patient->department->hospital->name }}</td>
                      <td>{{ $patient->department->name }}</td>
                     
                      <td>
                        <a class="btn btn-primary" href="{{ route('admin.patients.show',[$department->id,$patient->id]) }}"><i class="fa-solid fa-eye"></i></a>
                        <a class="btn btn-warning" href="{{ route('admin.patients.edit',[$department->id,$patient->id]) }}"><i class="fa-solid fa-pen-to-square"></i></a>
