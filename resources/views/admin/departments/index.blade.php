              ...
              <div class="card-body">
                ...
                <div class="col-sm-12 col-md-6">
                    <div id="example1_filter" class="dataTables_filter">
                        ...
                        <a class="btn btn-primary" href="{{ z('admin.departments.create',[$hospital->id]) }}"> + add department</a>   
                      </div>
                </div>
              </div>
            <div class="row">
                <div class="col-sm-12">
                  ...
                  <thead>
                  <tr role="row">
                    <th class="sorting sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">Department Name</th>
                    ...
                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">Doctors_num</th>
                  </tr>
                  </thead>
                  <tbody>
                  ...
                  <tr class="odd">
                      ...
                      <td>
                        <a class="btn btn-primary" href="{{ route('admin.departments.show',[$hospital->id,$department->id]) }}"><i class="fa-solid fa-eye"></i></a>
                        <a class="btn btn-warning" href="{{ route('admin.departments.edit',[$hospital->id,$department->id]) }}"><i class="fa-solid fa-pen-to-square"></i></a>
