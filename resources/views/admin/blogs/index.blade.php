            ...
            <div class="row">
                <div class="col-sm-12">
                  ...
                  <tr role="row">
                    ...
                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Date of published</th>
                    ...
                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending">Hospital Name</th>
                     ...
                     <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending">Tags</th>
                  ...
                  @foreach ($blogs as $blog)
                      ...
                      <td>{{ $blog->department->hospital->name}}</td>
                      <td>{{ $blog->department->name }}</td>
                      <td>
                       @if(!empty($blog->tags))
                          {{ implode('، ', $blog->tags) }}
                        @endif
                      ...
                      <td>
                        <a class="btn btn-primary" href="{{ route('admin.blogs.show',[$department->id,$blog->id]) }}"><i class="fa-solid fa-eye"></i></a>
                        <a class="btn btn-warning" href="{{ route('admin.blogs.edit',[$department->id,$blog->id]) }}"><i class="fa-solid fa-pen-to-square"></i></a>
